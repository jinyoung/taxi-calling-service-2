            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="taxiDrivers"
                        to="/taxiDriverManagements/taxiDrivers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="platformOperators"
                        to="/platformOperations/platformOperators"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '고객', 
                description: '고객 정보를 관리하는 Aggregate', 
                key: 'customers', 
            ...
            { 
                title: '택시 운송사', 
                description: '택시 운송사 정보를 관리하는 Aggregate', 
                key: 'taxiDrivers', 
                route: '/taxiDriverManagements/taxiDrivers',
                ImageUrl: '',
            },
            { 
                title: '플랫폼 운영자', 
                description: '플랫폼 운영자 정보를 관리하는 Aggregate', 
                key: 'platformOperators', 
                route: '/platformOperations/platformOperators',
                ImageUrl: '',
            },
